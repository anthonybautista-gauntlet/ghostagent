...
import { resolveModuleUrlFromLib, resolvePathFromLib } from './runtime-paths';
...
async function run() {
  const fixturePath = resolvePathFromLib({
    overridePath: process.env.AGENTFORGE_DETERMINISTIC_GOLDEN_FIXTURE_PATH,
